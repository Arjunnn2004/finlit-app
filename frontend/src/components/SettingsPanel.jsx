    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Panel */}
          <div className={`absolute right-0 top-12 w-80 ${theme.cardBg} ${theme.border} border ${theme.shadow} rounded-xl p-6 z-50 transition-all duration-200`}>
            <h3 className={`text-lg font-semibold ${theme.text} mb-4`}>Settings</h3>
